...
class ToolYoloDetectionNode:
    ...
    def detect(self, image,object,padding):
        ...
        self.download_large_file('https://huggingface.co/Bingsu/adetailer/resolve/main/face_yolov8n.pt?download=true',os.path.join(folder_paths.get_folder_paths("yolov8")[0],'face_yolov8n.pt'))
        ...
        if object == "face":
            model = YOLO(f'{os.path.join(folder_paths.models_dir, "yolov8")}/face_yolov8n.pt')  # load face model
        else:
